...
var Botkit = {
  ...
  send: function (text, e) {
    ...
    this.clearReplies();
    that.renderHumanMessage(message);
  ...
  renderMessage: function (message) {
    ...
    that.next_line.innerHTML = that.bot_message_template({
      message: message,
    });
    if (!message.isTyping) {
  ...
  boot: function (user) {
    ...
    var source = document.getElementById("bot_message_template").innerHTML;
    that.bot_message_template = Handlebars.compile(source);
